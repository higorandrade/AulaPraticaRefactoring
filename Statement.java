...
public class Statement {
  protected String value(Customer aCustomer, String text1, String text2, String text3, String text4, String text5, String text6, String text7, String text8, String text9) {
